// Time Complexity: O(N) since worst case, if there are only two words at beginning and end and all
// others are sparse characters, then it's going to increment and decrement right and left
